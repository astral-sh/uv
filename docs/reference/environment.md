...
<small class="env-var-since">added in `0.1.32`</small>
...
### `UV_BUILD_CONSTRAINT`
<small class="env-var-since">added in `0.2.34`</small>
...
<small class="env-var-since">added in `0.1.45`</small>

Controls the number of threads used when installing and unzipping
packages.

### `UV_CONFIG_FILE`
<small class="env-var-since">added in `0.1.34`</small>
...
### `UV_DEFAULT_INDEX`
<small class="env-var-since">added in `0.4.23`</small>
...
### `UV_DEV`
<small class="env-var-since">added in `0.8.7`</small>

Equivalent to the `--dev` command-line argument. If set, uv will include
development dependencies.

### `UV_DOWNLOAD_URL`
<small class="env-var-since">added in `0.8.4`</small>
...
### `UV_ENV_FILE`
<small class="env-var-since">added in `0.4.30`</small>

`.env` files from which to load environment variables when executing `uv run` commands.

### `UV_EXCLUDE_NEWER`
<small class="env-var-since">added in `0.2.12`</small>

Equivalent to the `--exclude-newer` command-line argument. If set, uv will
exclude distributions published after the specified date.

### `UV_EXTRA_INDEX_URL`
<small class="env-var-since">added in `0.1.3`</small>
...
### `UV_FIND_LINKS`
<small class="env-var-since">added in `0.4.19`</small>
...
### `UV_INDEX_STRATEGY`
<small class="env-var-since">added in `0.1.29`</small>
...
<small class="env-var-since">added in `0.5.0`</small>
...
### `UV_LINK_MODE`
<small class="env-var-since">added in `0.1.40`</small>
...
### `UV_LOG_CONTEXT`
<small class="env-var-since">added in `0.6.4`</small>
...
### `UV_MANAGED_PYTHON`
<small class="env-var-since">added in `0.6.8`</small>
...
### `UV_NO_BINARY`
<small class="env-var-since">added in `0.5.30`</small>
...
### `UV_NO_BUILD_PACKAGE`
<small class="env-var-since">added in `0.6.5`</small>
...
### `UV_NO_CACHE`
<small class="env-var-since">added in `0.1.2`</small>

Equivalent to the `--no-cache` command-line argument. If set, uv will not use the
cache for any operations.

### `UV_NO_CONFIG`
<small class="env-var-since">added in `0.2.30`</small>
...
### `UV_NO_EDITABLE`
<small class="env-var-since">added in `0.6.15`</small>
...
<small class="env-var-since">added in `0.7.13`</small>

Disable GitHub-specific requests that allow uv to skip `git fetch` in some circumstances.

### `UV_NO_HF_TOKEN`
<small class="env-var-since">added in `0.8.1`</small>

Disable Hugging Face authentication, even if `HF_TOKEN` is set.

### `UV_NO_INSTALLER_METADATA`
<small class="env-var-since">added in `0.5.7`</small>
...
### `UV_OVERRIDE`
<small class="env-var-since">added in `0.2.22`</small>
...
### `UV_PRERELEASE`
<small class="env-var-since">added in `0.1.16`</small>

Equivalent to the `--prerelease` command-line argument. For example, if set to
`allow`, uv will allow pre-release versions for all dependencies.

### `UV_PREVIEW`
<small class="env-var-since">added in `0.1.37`</small>
...
### `UV_PROJECT`
<small class="env-var-since">added in `0.4.4`</small>
...
### `UV_PUBLISH_INDEX`
<small class="env-var-since">added in `0.5.8`</small>
...
### `UV_PUBLISH_PASSWORD`
<small class="env-var-since">added in `0.4.16`</small>
...
<small class="env-var-since">added in `0.2.35`</small>
...
### `UV_PYTHON_BIN_DIR`
<small class="env-var-since">added in `0.4.29`</small>

Specifies the directory to place links to installed, managed Python executables.

### `UV_PYTHON_CACHE_DIR`
<small class="env-var-since">added in `0.7.0`</small>
...
### `UV_PYTHON_DOWNLOADS`
<small class="env-var-since">added in `0.3.2`</small>
...
<small class="env-var-since">added in `0.6.13`</small>
...
<small class="env-var-since">added in `0.8.0`</small>
...
### `UV_REQUEST_TIMEOUT`
<small class="env-var-since">added in `0.1.6`</small>
...
### `UV_RESOLUTION`
<small class="env-var-since">added in `0.1.27`</small>

Equivalent to the `--resolution` command-line argument. For example, if set to
`lowest-direct`, uv will install the lowest compatible versions of all direct dependencies.

### `UV_S3_ENDPOINT_URL`
<small class="env-var-since">added in `0.8.21`</small>
...
### `UV_SYSTEM_PYTHON`
<small class="env-var-since">added in `0.1.18`</small>
...
### `UV_TOOL_BIN_DIR`
<small class="env-var-since">added in `0.3.0`</small>

Specifies the "bin" directory for installing tool executables.

### `UV_TOOL_DIR`
<small class="env-var-since">added in `0.2.16`</small>

Specifies the directory where uv stores managed tools.

### `UV_TORCH_BACKEND`
<small class="env-var-since">added in `0.6.9`</small>
...
### `UV_VENV_SEED`
<small class="env-var-since">added in `0.5.21`</small>
...
### `ALL_PROXY`
<small class="env-var-since">added in `0.1.38`</small>

General proxy for all network requests.

### `ANDROID_API_LEVEL`
<small class="env-var-since">added in `0.8.16`</small>
...
### `APPDATA`
<small class="env-var-since">added in `0.1.42`</small>
...
### `BASH_VERSION`
<small class="env-var-since">added in `0.1.28`</small>
...
### `COLUMNS`
<small class="env-var-since">added in `0.6.2`</small>
...
### `CONDA_ROOT`
<small class="env-var-since">added in `0.8.18`</small>
...
### `FORCE_COLOR`
<small class="env-var-since">added in `0.2.7`</small>
...
### `JPY_SESSION_NAME`
<small class="env-var-since">added in `0.2.6`</small>

Used to detect when running inside a Jupyter notebook.

### `KSH_VERSION`
<small class="env-var-since">added in `0.2.33`</small>
...
### `PYTHONPATH`
<small class="env-var-since">added in `0.1.22`</small>
...
### `SSL_CERT_FILE`
<small class="env-var-since">added in `0.1.14`</small>

Custom certificate bundle file path for SSL connections.

### `SSL_CLIENT_CERT`
<small class="env-var-since">added in `0.2.11`</small>
...
### `SYSTEMDRIVE`
<small class="env-var-since">added in `0.4.26`</small>
...
### `UV`
<small class="env-var-since">added in `0.6.0`</small>
...
### `XDG_CACHE_HOME`
<small class="env-var-since">added in `0.1.17`</small>
...
### `ZDOTDIR`
<small class="env-var-since">added in `0.2.25`</small>
