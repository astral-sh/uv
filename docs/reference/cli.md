...
```
uv bump [OPTIONS] [BUMP]
```

<h3 class="cli-reference">Arguments</h3>

<dl class="cli-reference"><dt><code>BUMP</code></dt><dd><p>The version bump to apply</p>
...
</dd><dt><code>--raw</code> <i>raw</i></dt><dd><p>The version to set</p>
