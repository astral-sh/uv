...
</dd><dt><code>--exact</code></dt><dd><p>Remove extraneous packages present in the environment.</p>

<p>When enabled, uv will remove any extraneous packages from the environment</p>
