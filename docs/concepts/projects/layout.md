...
An optional [build-dependency lock](../../reference/internals/build-dependencies.md) adds required
build environments for one observed executor without changing the universal runtime graph.
