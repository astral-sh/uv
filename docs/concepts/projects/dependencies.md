...
[dependency specifiers](../../reference/dependency-specifiers.md) syntax, and the table follows the
...
[dependency specifiers](../../reference/dependency-specifiers.md) syntax.
