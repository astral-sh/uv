...
- `UV_FIND_LINKS`: Equivalent to the `--find-links` command-line argument. If set, uv will
  use this space-separated list of additional locations to search for packages.
