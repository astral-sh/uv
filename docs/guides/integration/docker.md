...
`ghcr.io/astral-sh/uv:{major}.{minor}-{base}`, e.g., `ghcr.io/astral-sh/uv:0.11.14-alpine`.
...
!!! tip
    ...
    version tag, e.g., `ghcr.io/astral-sh/uv:0.11.14`, or (even better) the specific image digest,
