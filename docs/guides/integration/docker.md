...
- `ghcr.io/astral-sh/uv:{major}.{minor}.{patch}`, e.g., `ghcr.io/astral-sh/uv:0.6.9`
...
`ghcr.io/astral-sh/uv:{major}.{minor}-{base}`, e.g., `ghcr.io/astral-sh/uv:0.6.9-alpine`.
...
!!! tip
    ...
    version tag, e.g., `ghcr.io/astral-sh/uv:0.6.9`, or (even better) the specific image digest,
