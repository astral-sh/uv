...
# 1. Single platform
${uv} venv --clear -q -p 3.13 &&  echo "torch" | ${uv} pip compile - --index https://wheelnext.github.io/variants-index/v0.0.2 --no-annotate --refresh

export NV_VARIANT_PROVIDER_FORCE_CUDA_DRIVER_VERSION=12.8
export NV_VARIANT_PROVIDER_FORCE_SM_ARCH=9.0
${uv} venv --clear -q -p 3.13 && echo "torch" | ${uv} pip compile - --index https://wheelnext.github.io/variants-index/v0.0.2 --no-annotate
