...
const LAUNCHER_T32: &[u8] = include_bytes!("../windows-launcher/t32.exe");
const LAUNCHER_T64: &[u8] = include_bytes!("../windows-launcher/t64.exe");
const LAUNCHER_T64_ARM: &[u8] = include_bytes!("../windows-launcher/t64-arm.exe");
