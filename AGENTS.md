...
- PREFER the default development and test profiles for focused checks and short edit/test cycles
- For substantial or repeated integration-test runs, consider
  `cargo nextest run --cargo-profile fast-build` to optimize test execution
