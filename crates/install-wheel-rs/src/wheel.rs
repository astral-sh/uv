...
const LAUNCHER_X86_64_GUI: &[u8] =
    include_bytes!("../../axi-trampoline/trampolines/axi-trampoline-x86_64-gui.exe");

#[cfg(all(windows, target_arch = "x86_64"))]
const LAUNCHER_X86_64_CONSOLE: &[u8] =
    include_bytes!("../../axi-trampoline/trampolines/axi-trampoline-x86_64-console.exe");

#[cfg(all(windows, target_arch = "aarch64"))]
const LAUNCHER_AARCH64_GUI: &[u8] =
    include_bytes!("../../axi-trampoline/trampolines/axi-trampoline-aarch64-gui.exe");

#[cfg(all(windows, target_arch = "aarch64"))]
const LAUNCHER_AARCH64_CONSOLE: &[u8] =
    include_bytes!("../../axi-trampoline/trampolines/axi-trampoline-aarch64-console.exe");
