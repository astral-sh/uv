...
/// A cache of wheels downloaded from remote distributions.
pub(crate) struct BuiltDistributionFetcher<'a, T: BuildContext>(&'a T);

impl<'a, T: BuildContext> BuiltDistributionFetcher<'a, T> {
