...
async fn msgraph_sdk() -> Result<()> {
    ...
    assert_snapshot!(err, @r###"
    Because msgraph-sdk==1.0.0 depends on msgraph-core>=1.0.0a2 and root depends on msgraph-sdk==1.0.0, we can conclude that the requirements are unsatisfiable.
