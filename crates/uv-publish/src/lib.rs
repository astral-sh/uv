...
///
/// Files can be prepared and uploaded individually.
#[must_use]
...
mod tests {
    ...
    use crate::{
        FormMetadata, PublishError, PublishPrepareError, PublishSession, Reporter,
        UploadDistribution, UploadOutcome, group_files, source_dist_pkg_info,
    };
