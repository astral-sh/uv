...
This version (0.0.61) is a component of [uv 0.11.28](https://crates.io/crates/uv/0.11.28). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.28/crates/uv-configuration).
