...
This version (0.0.63) is a component of [uv 0.11.30](https://crates.io/crates/uv/0.11.30). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.30/crates/uv-configuration).
