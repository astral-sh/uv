...
This version (0.0.82) is a component of [uv 0.12.15](https://crates.io/crates/uv/0.12.15). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.15/crates/uv-configuration).
