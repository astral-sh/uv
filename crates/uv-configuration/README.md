...
This version (0.0.86) is a component of [uv 0.12.19](https://crates.io/crates/uv/0.12.19). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.19/crates/uv-configuration).
