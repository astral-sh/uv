...
This version (0.0.47) is a component of [uv 0.11.14](https://crates.io/crates/uv/0.11.14). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.14/crates/uv-configuration).
