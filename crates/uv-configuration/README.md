...
This version (0.0.85) is a component of [uv 0.12.18](https://crates.io/crates/uv/0.12.18). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.18/crates/uv-configuration).
