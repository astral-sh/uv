...
This version (0.0.81) is a component of [uv 0.12.14](https://crates.io/crates/uv/0.12.14). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.14/crates/uv-configuration).
