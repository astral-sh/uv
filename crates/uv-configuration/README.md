...
This version (0.0.51) is a component of [uv 0.11.18](https://crates.io/crates/uv/0.11.18). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.18/crates/uv-configuration).
