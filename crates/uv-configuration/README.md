...
This version (0.0.84) is a component of [uv 0.12.17](https://crates.io/crates/uv/0.12.17). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.17/crates/uv-configuration).
