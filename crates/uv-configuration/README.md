...
This version (0.0.48) is a component of [uv 0.11.15](https://crates.io/crates/uv/0.11.15). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.15/crates/uv-configuration).
