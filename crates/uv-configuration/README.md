...
This version (0.0.79) is a component of [uv 0.12.12](https://crates.io/crates/uv/0.12.12). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.12/crates/uv-configuration).
