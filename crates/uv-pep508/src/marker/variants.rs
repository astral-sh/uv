...
impl FromStr for VariantNamespace {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        ...
        Ok(VariantNamespace(input.to_string()))
    }
}
...
impl<'de> Deserialize<'de> for VariantNamespace {
        ...
        D: Deserializer<'de>,
    {
        ...
        VariantNamespace::from_str(&s).map_err(serde::de::Error::custom)
    }
}
...
impl FromStr for VariantFeature {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        ...
        Ok(VariantFeature(input.to_string()))
    }
}
...
impl<'de> Deserialize<'de> for VariantFeature {
    ...
    {
        let s = String::deserialize(deserializer)?;
        VariantFeature::from_str(&s).map_err(serde::de::Error::custom)
    }
}
...
impl FromStr for VariantValue {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        ...
        Ok(VariantValue(input.to_string()))
    }
}
...
impl<'de> Deserialize<'de> for VariantValue {
    ...
    {
        let s = String::deserialize(deserializer)?;
        VariantValue::from_str(&s).map_err(serde::de::Error::custom)
    }
}
