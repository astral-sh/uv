...
use crate::source::{
    HttpRevisionPointer, LocalRevisionPointer, RevisionHashes, HASHES, HTTP_REVISION,
    LOCAL_REVISION,
};
use crate::Error;
...
use uv_distribution_types::{
    DirectUrlSourceDist, DirectorySourceDist, GitDirectorySourceDist, GitPathSourceDist, Hashed,
    PathSourceDist,
};
use uv_fs::symlinks;
