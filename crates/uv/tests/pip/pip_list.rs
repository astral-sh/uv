...
fn list_format_json() {
    ...
    exit_code: 0
    ----- stdout -----
    [{"name":"anyio","version":"4.3.0","shadowed":false},{"name":"idna","version":"3.6","shadowed":false},{"name":"poetry-editable","version":"0.1.0","editable_project_location":"[WORKSPACE]/test/packages/poetry_editable","shadowed":false},{"name":"sniffio","version":"1.3.1","shadowed":false}]
    ...
    exit_code: 0
    ----- stdout -----
    [{"name":"poetry-editable","version":"0.1.0","editable_project_location":"[WORKSPACE]/test/packages/poetry_editable","shadowed":false}]
...
fn list_system_site_packages() -> Result<()> {
    ...
    ----- stderr -----
    Using CPython 3.12.[X] interpreter at: cpython-3.12.[X]-[PLATFORM]/bin/python3.12
