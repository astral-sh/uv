...
fn test_shared_libraries() {
    ...
    for (app_name, numpy_version) in [("app1", "2.0.0"), ("app2", "1.26.4")] {
        ...
        filters.push((" 4 packages in ", " X packages in "));
        filters.push((" 5 packages in ", " X packages in "));
        filters.push((" 6 packages in ", " X packages in "));
        filters.push((" 7 packages in ", " X packages in "));
        ...
        Prepared X packages in [TIME]
        Installed X packages in [TIME]
