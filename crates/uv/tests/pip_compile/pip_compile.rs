...
/// Warn unless the build-dependency inclusion preview feature has been enabled.
#[test]
fn include_build_dependencies_preview() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let server = PackseServer::empty();
    context
        .temp_dir
        .child("requirements.in")
        .write_str("packaging==23.2")?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --include-build-dependencies
    packaging==23.2
        # via -r requirements.in
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--include-build-dependencies")
        .arg("--preview-features").arg("include-build-dependencies"), @"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --include-build-dependencies --preview-features include-build-dependencies
    packaging==23.2
        # via -r requirements.in
...
/// Omit source distribution hashes when the selected version has a compatible wheel.
#[test]
...
fn include_build_dependencies_source_distribution() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --include-build-dependencies --generate-hashes -o requirements.txt
    editables==0.5 \
...
fn include_build_dependencies_recursive_build_constraint() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-constraint build-constraints.txt --include-build-dependencies --generate-hashes
    build-helper==1.0.0 \
        --hash=sha256:b781f17695678891fa508d8e91cd7a33a2089b01d79102d629a620e0f0c0ff5e
