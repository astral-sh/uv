...
/// Coalesce prefetched versions whose dependencies are unchanged while repeatedly backtracking a
/// parent package. The older core version is a dependency boundary and must remain selectable.
#[test]
