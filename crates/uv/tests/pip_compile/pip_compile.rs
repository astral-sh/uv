...
fn override_dependency() -> Result<()> {
    ...
    context
        .temp_dir
        .child("duplicate-overrides.txt")
        .write_str("werkzeug==2.3.0")?;
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
            ...
            .arg("overrides.txt")
            .arg("--override")
            .arg("duplicate-overrides.txt"), @"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --override overrides.txt --override duplicate-overrides.txt
    blinker==1.7.0
        # via flask
    click==8.1.7
        # via flask
    ...
    werkzeug==2.3.0
        # via
        #   --override duplicate-overrides.txt
        #   --override overrides.txt
        #   flask
...
fn scoped_override_dependency_from_pyproject() -> Result<()> {
    ...
    override-dependencies = [
      ...
      { package = { name = "anyio" }, dependencies = ["idna==3.2"] },
