...
/// Compile from a `--find-links` directory relative to the containing requirements file.
#[test]
fn find_links_relative_to_requirements_file() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements/requirements.in
    ok==1.0.0
