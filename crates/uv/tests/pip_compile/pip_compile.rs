...
"#,
    ...
    // Preserve self-constraints reached through another extra, including the marker on that
    // recursive path.
    pyproject_toml.write_str(
        r#"
[project]
...
"#,
    ...
    // Neither the production self-constraint nor the recursive path applies on Linux.
    uv_snapshot!(context.filters(), context.pip_compile()
            .arg("pyproject.toml")
            .arg("--extra")
            .arg("outer")
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] pyproject.toml --extra outer --constraint constraints.txt --python-platform x86_64-unknown-linux-gnu --no-index --no-build
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --python-platform x86_64-unknown-linux-gnu --no-index --no-build
    .
        # via -r requirements.in
