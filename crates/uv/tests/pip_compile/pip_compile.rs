...
/// Omit source distribution hashes when the selected version has a compatible wheel, while
/// warning that build dependency inclusion is experimental.
#[test]
fn include_build_dependencies_wheel_hashes() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("anyio==4.0.0")?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --include-build-dependencies --generate-hashes
    anyio==4.0.0 \
        --hash=sha256:cfdb2b588b9fc25ede96d8db56ed50848b0b649dca3dd1df0b11f683bb9e0b5f
        # via -r requirements.in
    idna==3.6 \
    ...
    ----- stderr -----
    warning: The `--include-build-dependencies` option is experimental and may change without warning. Pass `--preview-features include-build-dependencies` to disable this warning.
    Resolved 3 packages in [TIME]
    ");
...
/// Include the complete build dependency closure without preferring an older wheel.
#[test]
fn include_build_dependencies_source_distribution() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let mut scenario = Scenario::empty();
    scenario.packages.insert(
        PackageName::from_str("source-only")?,
        Package {
            versions: BTreeMap::from([
                (
                ...
                (
                    ...
                    PackageMetadata {
                        requires: vec![Requirement::from_str("runtime==1.0.0")?],
                        sdist: true,
                        wheel: false,
                        ..PackageMetadata::default()
                    },
    ...
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("source-only>=0.9.0")?;
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--include-build-dependencies")
        .arg("--generate-hashes")
        .arg("-o").arg("requirements.txt")
        .arg("--preview-features").arg("include-build-dependencies"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --include-build-dependencies --generate-hashes -o requirements.txt --preview-features include-build-dependencies
    editables==0.5 \
        --hash=sha256:61e5ffa82629e0d8bfe09bc44a07db3c1ab8ed1ce78a6980732870f19b5e7d4c
        # via hatchling
    hatchling==1.20.0 \
        --hash=sha256:872c63aa7e8aca85e8dba07b05c6a9b28d5a149fe00638f1a47e36930197248f
    packaging==23.2 \
    ...
    pluggy==1.3.0 \
        ...
        # via hatchling
    runtime==1.0.0 \
        --hash=sha256:2c9c70d7ef21d305ef4edd9faae59882818f73c18d0ceced9f4232f48f2f3c1a
        # via source-only
    source-only==1.0.0 \
        --hash=sha256:e6d09263263c0b03bcfacac277b8550258c17f9765314381a2aa7560d9b630ef
        # via -r requirements.in
    ...
    uv_snapshot!(context.filters(), context.pip_install()
        .arg("--index-url").arg(server.index_url())
        .arg("--require-hashes")
        .arg("--build-constraint").arg(requirements_txt.path())
        .arg("-r").arg(requirements_txt.path())
...
fn include_build_dependencies_dynamic_hook_cached() -> Result<()> {
    ...
    project.child("pyproject.toml").write_str(indoc! {r#"
        ...
        name = "local-project"
        version = "1.0.0"
        description = "A package with a dynamic build dependency"
    "#})?;
    ...
    "#})?;
    project.child("local_project.py").write_str("")?;

    context.temp_dir.child("uv.toml").write_str(indoc! {r#"
        preview-features = ["include-build-dependencies"]
    ...
    // Structured output also includes the build closure without exposing source fallbacks.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("-o").arg("pylock.toml"), @r#"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    ...
    name = "flit-core"
    version = "3.9.0"
    wheels = [{ url = "http://[LOCALHOST]/files/flit_core-3.9.0-py3-none-any.whl", upload-time = 2024-03-24T00:00:00Z, hashes = { sha256 = "7aada352fb0c7f5538c4fafeddf314d3a6a92ee8e2b1de70482329e42de70301" } }]
    ...
    name = "packaging"
    version = "23.2"
    wheels = [{ url = "http://[LOCALHOST]/files/packaging-23.2-py3-none-any.whl", upload-time = 2024-03-24T00:00:00Z, hashes = { sha256 = "8c491190033a9af7e1d931d0b5dacc2ef47509b34dd0de67ed209b5203fc88c7" } }]
    ...
    // An explicit command-line override takes precedence over the persisted setting.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--generate-hashes")
        .arg("--no-include-build-dependencies"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --generate-hashes --no-include-build-dependencies
    ./project
        # via -r requirements.in
...
/// Apply build constraints when build dependencies themselves require a source build.
#[test]
fn include_build_dependencies_recursive_build_constraint() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let mut scenario = Scenario::empty();
    scenario.packages.insert(
        PackageName::from_str("build-helper")?,
        Package {
            versions: BTreeMap::from([
                (
                    Version::from_str("1.0.0")?,
    ...
    project.child("pyproject.toml").write_str(indoc! {r#"
        ...
        name = "local-project"
        version = "1.0.0"
        description = "A package with a source-only build dependency"
    "#})?;
    project.child("backend.py").write_str(indoc! {r#"
        from flit_core.buildapi import *
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--include-build-dependencies")
        .env(EnvVars::UV_PREVIEW_FEATURES, "include-build-dependencies"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-constraint build-constraints.txt --include-build-dependencies
    build-helper==1.0.0
...
/// Build dependency closures cannot be represented soundly in universal requirements output.
#[test]
fn include_build_dependencies_universal() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("anyio==4.0.0")?;
    ...
    exit_code: 2 (failure)
    ----- stderr -----
    error: `--include-build-dependencies` is not supported with `--universal`
    ");

    Ok(())
}

/// Select source distribution hashes independently of dependency resolution.
#[test]
fn artifact_policy_hashes() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    context
        .temp_dir
        .child("requirements.in")
        .write_str("anyio==4.0.0")?;

    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--generate-hashes")
        .arg("--artifact-policy").arg("all"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --generate-hashes --artifact-policy all
    anyio==4.0.0 \
        --hash=sha256:cfdb2b588b9fc25ede96d8db56ed50848b0b649dca3dd1df0b11f683bb9e0b5f \
        --hash=sha256:f7ed51751b2c2add651e5747c891b47e26d2a21be5d32d9311dfe9692f3e5d7a
        # via -r requirements.in
    ...
    ----- stderr -----
    warning: The `--artifact-policy` option is experimental and may change without warning. Pass `--preview-features include-build-dependencies` to disable this warning.
    Resolved 3 packages in [TIME]
    ");
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--generate-hashes")
        .arg("--artifact-policy").arg("necessary-sdists")
        .env(EnvVars::UV_PREVIEW_FEATURES, "include-build-dependencies"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --generate-hashes --artifact-policy necessary-sdists
    anyio==4.0.0 \
        --hash=sha256:cfdb2b588b9fc25ede96d8db56ed50848b0b649dca3dd1df0b11f683bb9e0b5f
        # via -r requirements.in
    idna==3.6 \
...
/// Retained source fallbacks contribute their build dependencies even when a wheel is selected.
#[test]
fn artifact_policy_all_includes_build_dependencies() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--include-build-dependencies")
        .arg("--artifact-policy").arg("all")
        .arg("--generate-hashes")
        .env(EnvVars::UV_PREVIEW_FEATURES, "include-build-dependencies"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --include-build-dependencies --artifact-policy all --generate-hashes
    a==1.0.0 \
...
/// Reject wheel-only output when the selected package version has no wheel.
#[test]
fn artifact_policy_wheels_only_requires_wheel() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "artifact-policy-wheels-only"
    ...
    context
        .temp_dir
        .child("requirements.in")
        .write_str("source-only>=0.9.0")?;

    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--artifact-policy").arg("wheels-only")
        .env(EnvVars::UV_PREVIEW_FEATURES, "include-build-dependencies"), @"
    exit_code: 2 (failure)
    ----- stderr -----
    Resolved 1 package in [TIME]
    error: The selected source distribution for `source-only` is excluded by the artifact policy
    ");

    Ok(())
}

/// Use existing required-environment wheel coverage to retain only necessary source fallbacks.
#[cfg(feature = "test-universal")]
#[test]
fn artifact_policy_universal_required_environments() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "artifact-policy-universal"
        ...
        [packages.covered.versions."1.0.0"]
        wheel_tags = ["py3-none-win_amd64", "py3-none-manylinux_2_17_x86_64"]
    ...
    context
        ...
        [tool.uv.pip]
        artifact-policy = "necessary-sdists"
    "#})?;
    ...
    version = "1.0.0"
    wheels = [
        { url = "http://[LOCALHOST]/files/covered-1.0.0-py3-none-manylinux_2_17_x86_64.whl", upload-time = 2024-03-24T00:00:00Z, hashes = { sha256 = "76d99fcf382715ecf2f2f25f4be74b942f34dda53968581d057b68284eba5321" } },
        { url = "http://[LOCALHOST]/files/covered-1.0.0-py3-none-win_amd64.whl", upload-time = 2024-03-24T00:00:00Z, hashes = { sha256 = "61ed989d1f9678bdab0329dbea71735865612f486b88b5be06c8e22f10972f84" } },
    ]

    [[packages]]
    name = "partial"
    version = "1.0.0"
    sdist = { url = "http://[LOCALHOST]/files/partial-1.0.0.tar.gz", upload-time = 2024-03-24T00:00:00Z, hashes = { sha256 = "4b23778c255a035cc0a71677236379c5ba5402139647c4ed08bdff1b965466a6" } }
    wheels = [{ url = "http://[LOCALHOST]/files/partial-1.0.0-py3-none-win_amd64.whl", upload-time = 2024-03-24T00:00:00Z, hashes = { sha256 = "c7fe19cac1d216c6a3d73f910d299f47256b3fd92f39b1f1e4e2cd06a3a75637" } }]
    ...
    // Explicit command-line settings override the persisted source-fallback policy.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--universal")
        .arg("-o").arg("pylock.toml")
        .arg("--artifact-policy").arg("source-only"), @r#"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal -o pylock.toml --artifact-policy source-only
    lock-version = "1.0"
    created-by = "uv"
    requires-python = ">=3.12"
