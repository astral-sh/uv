...
fn minimum_libc_filters_locked_wheels() -> Result<()> {
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.31" } },
        ]
    "#})?;
    uv_snapshot!(context.filters(), context.lock().arg("--offline"), @"
    exit_code: 0 (success)
    ----- stderr -----
    warning: Setting `minimum-libc-version` in `required-environments` is experimental and may change without warning. Pass `--preview-features minimum-libc-version` to disable this warning.
    Resolved 2 packages in [TIME]
    ");
    let lock = context.read("uv.lock");
    insta::with_settings!({filters => context.filters()}, {
        ...
        requires-python = ">=3.12"
        required-markers = [
            { marker = "platform_machine == 'x86_64' and sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31" } },
        ]
...
fn minimum_libc_both_families_and_musl_only() -> Result<()> {
    ...
    insta::with_settings!({filters => context.filters()}, {
        ...
        required-markers = [
            { marker = "platform_machine == 'x86_64' and sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31", musl = "1.2" } },
        ]
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        environments = ["sys_platform == 'linux' and platform_machine == 'x86_64'"]
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { musl = "1.2" } },
        ]
    "#})?;
    ...
    insta::with_settings!({filters => context.filters()}, {
        ...
        required-markers = [
            { marker = "platform_machine == 'x86_64' and sys_platform == 'linux'", minimum-libc-version = { musl = "1.2" } },
        ]
...
fn minimum_libc_backtracks_and_invalidates_lock() -> Result<()> {
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        find-links = ["links"]
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.17" } },
        ]
    "#})?;
    uv_snapshot!(context.filters(), context.lock().args(["--offline", "--locked"]), @"
    exit_code: 1 (failure)
...
fn minimum_libc_allows_sdist_fallback() -> Result<()> {
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        find-links = ["links"]
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.31", musl = "1.2" } },
        ]
    "#})?;
...
fn minimum_libc_direct_url() -> Result<()> {
    ...
    pyproject_toml.write_str(&formatdoc! {r#"
        ...
        no-index = true
        required-environments = [
            {{ marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = {{ glibc = "2.34", musl = "1.2" }} }},
        ]
    "#})?;
...
fn minimum_libc_architectures_and_markers() -> Result<()> {
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.31", musl = "1.2" } },
            { marker = "sys_platform == 'linux' and platform_machine == 'aarch64'", minimum-libc-version = { glibc = "2.31", musl = "1.2" } },
            "sys_platform == 'darwin'",
        ]
    "#})?;
    ...
    insta::with_settings!({filters => context.filters()}, {
        ...
        required-markers = [
            { marker = "platform_machine == 'x86_64' and sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31", musl = "1.2" } },
            { marker = "platform_machine == 'aarch64' and sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31", musl = "1.2" } },
            "sys_platform == 'darwin'",
        ]
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        find-links = ["links"]
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.29" } },
            { marker = "sys_platform == 'linux' and platform_machine == 'aarch64'", minimum-libc-version = { glibc = "2.31" } },
    ...
    insta::with_settings!({filters => context.filters()}, {
        ...
        required-markers = [
            { marker = "platform_machine == 'x86_64' and sys_platform == 'linux'", minimum-libc-version = { glibc = "2.29" } },
            { marker = "platform_machine == 'aarch64' and sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31" } },
            "sys_platform == 'darwin'",
        ]
        ...
        wheels = [
            { path = "demo-3.0.0-cp312-cp312-manylinux_2_31_aarch64.whl" },
            { path = "demo-3.0.0-cp312-cp312-manylinux_2_34_s390x.whl" },
            { path = "demo-3.0.0-cp312-cp312-macosx_11_0_arm64.whl" },
        ]
        ...
        source = { virtual = "." }
        dependencies = [
            { name = "demo", version = "2.0.0", source = { registry = "links" }, marker = "platform_machine == 'x86_64' and sys_platform == 'linux'" },
            { name = "demo", version = "3.0.0", source = { registry = "links" }, marker = "(platform_machine != 'x86_64' and sys_platform == 'linux') or sys_platform == 'darwin'" },
            { name = "windows-only", marker = "sys_platform == 'win32'" },
        ]
...
fn minimum_libc_invalid_configuration() -> Result<()> {
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        find-links = ["links"]
        required-environments = [
            { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.31.1" } },
        ]
    "#})?;
    uv_snapshot!(context.filters(), context.lock().arg("--offline"), @r#"
    exit_code: 2 (failure)
    ...
    warning: Failed to parse `pyproject.toml` during settings discovery:
      TOML parse error at line 11, column 109
         |
      11 |     { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.31.1" } },
         |                                                                                                             ^^^^^^^^
      expected a libc version in the form `<major>.<minor>` (e.g., `2.31` or `1.2`)

    error: Failed to parse: `pyproject.toml`
      cause: TOML parse error at line 11, column 109
                |
             11 |     { marker = "sys_platform == 'linux' and platform_machine == 'x86_64'", minimum-libc-version = { glibc = "2.31.1" } },
                |                                                                                                             ^^^^^^^^
             expected a libc version in the form `<major>.<minor>` (e.g., `2.31` or `1.2`)
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        [tool.uv]
        required-environments = [
            { marker = "sys_platform == 'linux'", minimum-libc-version = {} },
        ]
    "#})?;
    uv_snapshot!(context.filters(), context.lock().arg("--offline"), @r#"
    exit_code: 2 (failure)
    ----- stderr -----
    warning: Failed to parse `pyproject.toml` during settings discovery:
      TOML parse error at line 9, column 66
        |
      9 |     { marker = "sys_platform == 'linux'", minimum-libc-version = {} },
        |                                                                  ^^
      at least one of `glibc` or `musl` must be specified

    error: Failed to parse: `pyproject.toml`
      cause: TOML parse error at line 9, column 66
               |
             9 |     { marker = "sys_platform == 'linux'", minimum-libc-version = {} },
               |                                                                  ^^
             at least one of `glibc` or `musl` must be specified
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        [tool.uv]
        required-environments = [
            { marker = "sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31", unknown = "1.2" } },
        ]
    "#})?;
    uv_snapshot!(context.filters(), context.lock().arg("--offline"), @r#"
    exit_code: 2 (failure)
    ----- stderr -----
    warning: Failed to parse `pyproject.toml` during settings discovery:
      TOML parse error at line 9, column 84
        |
      9 |     { marker = "sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31", unknown = "1.2" } },
        |                                                                                    ^^^^^^^
      unknown field `unknown`, expected `glibc` or `musl`

    error: Failed to parse: `pyproject.toml`
      cause: TOML parse error at line 9, column 84
               |
             9 |     { marker = "sys_platform == 'linux'", minimum-libc-version = { glibc = "2.31", unknown = "1.2" } },
               |                                                                                    ^^^^^^^
             unknown field `unknown`, expected `glibc` or `musl`
