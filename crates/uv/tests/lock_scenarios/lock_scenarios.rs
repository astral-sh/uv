...
fn conflict_in_fork() -> Result<()> {
    ...
    error: No solution found when resolving dependencies for split (markers: sys_platform == 'os2')
      cause: Because all versions of b depend on d==1 and all versions of c depend on d==2, we can conclude that all versions of b and all versions of c are incompatible.
...
fn fork_non_local_fork_marker_direct() -> Result<()> {
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: Because all versions of a depend on c<2.0.0 and all versions of b depend on c>=2.0.0, we can conclude that all versions of b and all versions of a{sys_platform == 'linux'} are incompatible.
...
fn fork_non_local_fork_marker_transitive() -> Result<()> {
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: Because all versions of a depend on c{sys_platform == 'linux'}<2.0.0 and all versions of b depend on c{sys_platform == 'darwin'}>=2.0.0, we can conclude that all versions of a and all versions of b are incompatible.
