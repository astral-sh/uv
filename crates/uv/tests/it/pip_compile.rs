...
async fn package_name_on_index_package_mismatch() -> Result<()> {
    ...
    // An index page for sniffio, with both idna (wrong name) and sniffio distributions.
    let simple_page = r#"
    <!DOCTYPE html>
    <html>
        <body>
        <h1>Links for sniffio</h1>
        <a href="https://files.pythonhosted.org/packages/c2/e7/a82b05cf63a603df6e68d59ae6a68bf5064484a0718ea5033660af4b54a9/idna-3.6-py3-none-any.whl#sha256=c05567e9c24a6b9faaa835c4821bad0590fbb9d5779e7caa6e1cc4978e7eb24f">idna-3.6-py3-none-any.whl</a><br />
        <a href="https://files.pythonhosted.org/packages/bf/3f/ea4b9117521a1e9c50344b909be7886dd00a519552724809bb1f486986c2/idna-3.6.tar.gz#sha256=9ecdbbd083b06798ae1e86adcbfe8ab1479cf864e4ee30fe4e46a003d12491ca">idna-3.6.tar.gz</a><br />
        <a href="https://files.pythonhosted.org/packages/e9/44/75a9c9421471a6c4805dbf2356f7c181a29c1879239abab1ea2cc8f38b40/sniffio-1.3.1-py3-none-any.whl#sha256=2f6da418d1f1e0fddd844478f41680e794e6051915791a034ff65e5f100525a2">sniffio-1.3.1-py3-none-any.whl</a><br />
        <a href="https://files.pythonhosted.org/packages/a2/87/a6771e1546d97e7e041b6ae58d80074f81b7d5121207425c964ddf5cfdbd/sniffio-1.3.1.tar.gz#sha256=f4324edc670a0f49750a81b895f35c3adb843cca46f0530f79fc1babb23789dc">sniffio-1.3.1.tar.gz</a><br />
    </body>
    </html>
    "#;
    Mock::given(method("GET"))
    ...
    // Skip over the idna version, resolve to sniffio.
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("sniffio")?;
    ...
    // When all versions in a range have wrong names, the resolution fails.
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("sniffio>1.3.1")?;
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because only sniffio<=1.3.1 is available and you require sniffio>1.3.1, we can conclude that your requirements are unsatisfiable.

          hint: The index `http://[LOCALHOST]/` returned a malformed response, the index page for `sniffio` returned information for `idna`
    ");
