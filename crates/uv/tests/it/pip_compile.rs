...
fn git_source_missing_tag() -> Result<()> {
    ...
    ----- stderr -----
      ...
      ╰─▶ process didn't exit successfully: `git fetch --force --update-head-ok '--filter=tree:0' 'https://github.com/astral-test/uv-public-pypackage' '+refs/tags/missing:refs/remotes/origin/tags/missing'` (exit status: 128)
          --- stderr
