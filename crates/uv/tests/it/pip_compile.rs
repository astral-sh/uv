...
fn universal_transitive_disjoint_locals() -> Result<()> {
    ...
    torch==2.0.0+cu118 ; platform_machine == 'x86_64'
        ...
        #   torchvision
        #   triton
    torchvision==0.15.1 ; platform_machine != 'x86_64' or sys_platform == 'win32'
        # via -r requirements.in
    torchvision==0.15.1+rocm5.4.2 ; platform_machine == 'x86_64' and sys_platform != 'win32'
        # via -r requirements.in
    triton==2.0.0 ; platform_machine == 'x86_64' and sys_platform == 'linux'
        # via torch
    typing-extensions==4.10.0
...
fn universal_nested_overlapping_local_requirement() -> Result<()> {
    ...
    networkx==3.2.1
        # via torch
    pytorch-triton-rocm==2.3.0 ; platform_machine != 'x86_64' and sys_platform != 'win32'
        # via torch
    sympy==1.12
        # via torch
    ...
    torch==2.0.0+cu118 ; platform_machine == 'x86_64'
        ...
        #   example
        #   triton
    torch==2.3.0 ; platform_machine != 'x86_64' and sys_platform == 'win32'
        # via -r requirements.in
    torch==2.3.0+rocm6.0 ; platform_machine != 'x86_64' and sys_platform != 'win32'
        # via -r requirements.in
    triton==2.0.0 ; platform_machine == 'x86_64' and sys_platform == 'linux'
        # via torch
    typing-extensions==4.10.0
...
fn universal_nested_disjoint_local_requirement() -> Result<()> {
    ...
    networkx==3.2.1
        # via torch
    pytorch-triton-rocm==2.3.0 ; os_name != 'Linux' and sys_platform != 'win32'
        # via torch
    sympy==1.12
        # via torch
    ...
    torch==2.0.0+cu118 ; os_name == 'Linux' and platform_machine == 'x86_64'
        ...
        #   example
        #   triton
    torch==2.3.0 ; os_name != 'Linux' and sys_platform == 'win32'
        # via -r requirements.in
    torch==2.3.0+rocm6.0 ; os_name != 'Linux' and sys_platform != 'win32'
        # via -r requirements.in
...
fn universal_marker_propagation() -> Result<()> {
    ...
    charset-normalizer==3.3.2
        # via requests
    cmake==3.28.4 ; platform_machine == 'x86_64' and sys_platform != 'win32'
    ...
    jinja2==3.1.3
        # via torch
    lit==18.1.2 ; platform_machine == 'x86_64' and sys_platform != 'win32'
        # via pytorch-triton-rocm
    markupsafe==2.1.5
        # via jinja2
    mpmath==1.3.0
    ...
    pillow==10.2.0
        # via torchvision
    pytorch-triton-rocm==2.0.2 ; platform_machine == 'x86_64' and sys_platform != 'win32'
        # via torch
    pytorch-triton-rocm==2.2.0 ; platform_machine != 'x86_64' and sys_platform != 'win32'
        # via torch
    requests==2.31.0
        # via torchvision
    sympy==1.12
        # via torch
    torch==2.0.0 ; platform_machine == 'x86_64' and sys_platform == 'win32'
        # via
        #   -r requirements.in
        #   torchvision
    torch==2.0.0+rocm5.4.2 ; platform_machine == 'x86_64' and sys_platform != 'win32'
        # via
        #   -r requirements.in
        #   pytorch-triton-rocm
        #   torchvision
    torch==2.2.0 ; platform_machine != 'x86_64' and sys_platform == 'win32'
        # via
        #   -r requirements.in
        #   torchvision
    torch==2.2.0+rocm5.7 ; platform_machine != 'x86_64' and sys_platform != 'win32'
        # via
        #   -r requirements.in
        #   torchvision
    torchvision==0.15.1 ; platform_machine == 'x86_64' and sys_platform == 'darwin'
        # via -r requirements.in
