...
fn no_lowest_warning_with_name_and_url() -> Result<()> {
    ...
    requirements_in.write_str(indoc::indoc! {r"
        anyio[trio]
        https://files.pythonhosted.org/packages/e6/e3/c4c8d473d6780ef1853d630d581f70d655b4f8d7553c6997958c283039a2/anyio-4.4.0.tar.gz
    "})?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] --resolution lowest --constraints [TEMP_DIR]/constraints.txt [TEMP_DIR]/requirements.in
