...
fn universal_platform_fork() -> Result<()> {
    ...
    jinja2==3.1.3
        ...
        #   -c constraints.txt
        #   torch
    markupsafe==2.1.5 ; python_full_version < '3.13'
        # via jinja2
    markupsafe==3.0.2 ; python_full_version >= '3.13'
        # via jinja2
    mpmath==1.3.0
        # via sympy
    networkx==3.3
...
fn universal_disjoint_locals() -> Result<()> {
    let context = uv_test::test_context!("3.11").with_exclude_newer("2025-01-30T00:00:00Z");
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str(indoc::indoc! {r"
        --find-links https://astral-sh.github.io/pytorch-mirror/whl/torch_stable.html
...
fn universal_disjoint_local_requirement() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal --python-version 3.11
    cmake==3.31.4 ; platform_machine == 'x86_64' and sys_platform == 'linux'
        # via triton
    .
        # via -r requirements.in
...
fn universal_disjoint_base_or_local_requirement() -> Result<()> {
    let context = uv_test::test_context!("3.9").with_exclude_newer("2025-01-30T00:00:00Z");
    ...
    pyproject_toml.write_str(indoc! {r#"
        ...
        dependencies = [
            ...
            "torch==2.0.0+cu118 ; python_version >= '3.10' and python_version < '3.11'",
            "torch==2.0.0+cpu ; python_version >= '3.11'"
        ]
        requires-python = ">=3.9"
    "#})?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal --python-version 3.9
    cmake==3.31.4 ; python_full_version < '3.11' and platform_machine == 'x86_64' and sys_platform == 'linux'
        # via triton
    .
        # via -r requirements.in
    filelock==3.17.0
    ...
    jinja2==3.1.5
        # via torch
    lit==18.1.8 ; python_full_version < '3.11' and platform_machine == 'x86_64' and sys_platform == 'linux'
        # via triton
    markupsafe==3.0.2
        # via jinja2
    mpmath==1.3.0
    ...
    sympy==1.13.3
        # via torch
    torch==2.0.0 ; (python_full_version < '3.10' and platform_machine == 'aarch64' and platform_python_implementation == 'CPython' and sys_platform == 'linux') or (python_full_version < '3.10' and sys_platform == 'darwin')
        # via
        #   -r requirements.in
        #   example
    torch==2.0.0+cpu ; python_full_version >= '3.11'
        # via
        #   -r requirements.in
        #   example
    torch==2.0.0+cu118 ; (python_full_version == '3.10.*' and platform_machine == 'aarch64' and platform_python_implementation == 'CPython' and sys_platform == 'linux') or (python_full_version < '3.11' and platform_machine != 'aarch64' and sys_platform == 'linux') or (python_full_version < '3.11' and platform_python_implementation != 'CPython' and sys_platform == 'linux') or (python_full_version == '3.10.*' and sys_platform == 'darwin') or (python_full_version < '3.11' and sys_platform != 'darwin' and sys_platform != 'linux')
        # via
        #   -r requirements.in
        #   example
        #   triton
    triton==2.0.0 ; python_full_version < '3.11' and platform_machine == 'x86_64' and sys_platform == 'linux'
        # via torch
    typing-extensions==4.12.2
        # via torch
