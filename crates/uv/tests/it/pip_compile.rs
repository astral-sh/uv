...
#[test]
fn universal_missing_platform() -> Result<()> {
    let context = TestContext::new("3.12");
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str(indoc::indoc! {r"
        --find-links https://download.pytorch.org/whl/torch_stable.html
    ...
    ----- stderr -----
      ...
      ╰─▶ Because torch==2.0.0+cu118 has no macOS-compatible wheels and you require torch==2.0.0+cu118, we can conclude that your requirements are unsatisfiable.
    "###
    );
...
fn universal_disjoint_locals() -> Result<()> {
    ...
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal
    filelock==3.13.1 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    jinja2==3.1.3 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    markupsafe==2.1.5 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via jinja2
    mpmath==1.3.0 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via sympy
    networkx==3.2.1 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    sympy==1.12 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    torch==2.0.0+cpu ; sys_platform == 'linux'
        # via -r requirements.in
    torch==2.0.0+cu118 ; sys_platform == 'win32'
        # via -r requirements.in
    typing-extensions==4.10.0 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
...
fn universal_transitive_disjoint_locals() -> Result<()> {
    ...
    requirements_in.write_str(indoc::indoc! {r"
        ...
        torch==2.0.0+cu118 ; sys_platform == 'win32'
        torch==2.0.0+cpu ; sys_platform == 'linux'
        torchvision==0.15.1 ; sys_platform == 'win32' or sys_platform == 'linux'
    "})?;
    ...
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal
    certifi==2024.2.2 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via requests
    charset-normalizer==3.3.2 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via requests
    filelock==3.13.1 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    ...
    networkx==3.2.1 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    numpy==1.26.4 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torchvision
    pillow==10.2.0 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torchvision
    requests==2.31.0 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torchvision
    sympy==1.12 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    torch==2.0.0+cpu ; sys_platform == 'linux'
    ...
    torch==2.0.0+cu118 ; sys_platform == 'win32'
        ...
        #   -r requirements.in
        #   torchvision
    torchvision==0.15.1+cu118 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via -r requirements.in
    typing-extensions==4.10.0 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via torch
    urllib3==2.2.1 ; sys_platform == 'linux' or sys_platform == 'win32'
        # via requests
...
fn universal_local_path_requirement() -> Result<()> {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies for split (sys_platform == 'darwin'):
      ╰─▶ Because only example==0.0.0 is available and example==0.0.0 depends on torch==2.0.0+cu118, we can conclude that all versions of example depend on torch==2.0.0+cu118.
          And because torch==2.0.0+cu118 has no macOS-compatible wheels and you require example, we can conclude that your requirements are unsatisfiable.
    "###
    );
...
fn universal_disjoint_local_requirement() -> Result<()> {
    ...
    torch==2.0.0+cpu ; sys_platform == 'win32'
        ...
        #   -r requirements.in
        #   example
    torch==2.0.0+cu118 ; sys_platform != 'darwin' and sys_platform != 'win32'
        # via
        #   -r requirements.in
        #   example
        #   triton
...
fn universal_disjoint_base_or_local_requirement() -> Result<()> {
    ...
    sympy==1.12
        # via torch
    torch==2.0.0 ; sys_platform != 'linux' and sys_platform != 'win32'
        # via
        #   -r requirements.in
        #   example
    torch==2.0.0+cpu ; sys_platform == 'linux'
...
fn universal_nested_disjoint_local_requirement() -> Result<()> {
    ...
    filelock==3.13.1
        ...
        #   pytorch-triton-rocm
        #   torch
    fsspec==2024.3.1 ; python_full_version >= '3.13'
        # via torch
    intel-openmp==2021.4.0 ; python_full_version >= '3.13' and sys_platform == 'win32'
        # via mkl
    jinja2==3.1.3
        # via torch
    markupsafe==2.1.5
        # via jinja2
    mkl==2021.4.0 ; python_full_version >= '3.13' and sys_platform == 'win32'
        # via torch
    mpmath==1.3.0
        # via sympy
    networkx==3.2.1
        # via torch
    pytorch-triton-rocm==2.3.0 ; python_full_version >= '3.13' and sys_platform != 'darwin' and sys_platform != 'win32'
        # via torch
    sympy==1.12
        # via torch
    tbb==2021.11.0 ; python_full_version >= '3.13' and sys_platform == 'win32'
        # via mkl
    torch==2.0.0 ; python_full_version < '3.13' and sys_platform == 'darwin'
        # via -r requirements.in
    torch==2.0.0+cpu ; python_full_version < '3.13' and sys_platform == 'linux'
        # via
        #   -r requirements.in
        #   example
    torch==2.0.0+cu118 ; python_full_version < '3.13' and sys_platform != 'darwin' and sys_platform != 'linux'
        # via
        #   -r requirements.in
        #   example
    torch==2.3.0 ; (python_full_version >= '3.13' and sys_platform == 'darwin') or (python_full_version >= '3.13' and sys_platform == 'win32')
        # via -r requirements.in
    torch==2.3.0+rocm6.0 ; python_full_version >= '3.13' and sys_platform != 'darwin' and sys_platform != 'win32'
        # via -r requirements.in
    typing-extensions==4.10.0
        # via torch
