...
"#,
    ...
    Fetching vulnerability data from pypa-zip...
    Scanning project dependencies...
    Fetching vulnerabilities for 1 packages from pypa-zip...
...
"#,
    ...
    Fetching vulnerability data from pypa-zip...
    Scanning project dependencies...
    Fetching vulnerabilities for 2 packages from pypa-zip...
    Matching against vulnerability database...
    Audit complete: 0 vulnerabilities found in 0 packages
    ");
...
fn test_audit_help_and_usage() {
    ...
    Options:
      ...
      -o, --output <OUTPUT>        Output file path
          ...
          --source <SOURCE>        Vulnerability data source to use [default: pypa-zip] [possible
                                   values: pypa-zip, pypi, osv]
...
"#,
    ...
    Fetching vulnerabilities for 0 packages from pypa-zip...
    Matching against vulnerability database...
    Audit complete: 0 vulnerabilities found in 0 packages
    ");
...
"#;
    ...
    1. 🟢 PYSEC-2024-230 [source: pypa-zip]
       Package: certifi v2024.2.2
       Severity: Low
       Summary: Certifi is a curated collection of Root Certificates for validating the trustworthiness of SSL certificates while ver...
    ...
    Fetching vulnerability data from pypa-zip...
    Scanning project dependencies...
    Fetching vulnerabilities for 3 packages from pypa-zip...
    Matching against vulnerability database...
...
"#,
    ...
    2. 🟢 PYSEC-2024-60 [source: pypa-zip]
       Package: idna v3.6
       Severity: Low
       Summary: A vulnerability was identified in the kjd/idna library, specifically within the `idna.encode()` function, affecting v...
    ...
    Fetching vulnerability data from pypa-zip...
    Scanning project dependencies...
    Fetching vulnerabilities for 6 packages from pypa-zip...
    Matching against vulnerability database...
