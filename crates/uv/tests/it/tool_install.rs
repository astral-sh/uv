...
/// Installing a workspace project as a tool with --no-editable should install
/// workspace members as non-editable so the tool remains usable if sources change.
#[test]
