...
fn python_install_emulated_windows_x86_on_x64() {
    ...
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.13.9-windows-x86-none/bin/python3.13
    ...
    ----- stdout -----
    cpython-3.13.9-windows-x86_64-none    <download available>
    cpython-3.13.9-windows-x86-none       managed/cpython-3.13.9-windows-x86-none/bin/python3.13
    ...
    exit_code: 0
    ----- stdout -----
    [TEMP_DIR]/managed/cpython-3.13.9-windows-x86_64-none/bin/python3.13
