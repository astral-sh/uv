    ...
    Global options:
      ...
      -v, --verbose...
          ...
          --native-tls
              ...
              However, in some cases, you may want to use the native-tls backend instead, which uses the
              platform's native TLS implementation (e.g., SChannel on Windows, Secure Transport on
