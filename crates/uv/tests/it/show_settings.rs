...
fn preview_features() {
    ...
    GlobalSettings {
        ...
        preview: Preview {
            flags: PreviewFeatures(
                PYTHON_INSTALL_DEFAULT | PYTHON_UPGRADE | JSON_OUTPUT | PYLOCK | ADD_BOUNDS | PACKAGE_CONFLICTS | EXTRA_BUILD_DEPENDENCIES | DETECT_MODULE_CONFLICTS | FORMAT | NATIVE_AUTH | S3_ENDPOINT | CACHE_SIZE | DEPRECATE_PROJECT_FOR_INIT,
            ),
        },
        python_preference: Managed,
        python_downloads: Automatic,
