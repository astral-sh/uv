...
/// `uv export --no-sources` should ignore workspace members declared via `tool.uv.sources`.
///
/// See: <https://github.com/astral-sh/uv/issues/18258>
#[test]
fn export_no_sources_workspace_member_switch() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    uv_snapshot!(context.filters(), context.export().arg("--no-sources"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --no-sources
    -e .
    anyio==4.3.0 \
...
/// `uv export --no-sources-package` should only ignore the selected workspace member.
///
/// See: <https://github.com/astral-sh/uv/issues/18258>
#[test]
fn export_no_sources_package_workspace_member_switch() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --no-sources-package anyio
    -e .
    -e ./iniconfig
        # via foo
    anyio==4.3.0 \
