...
/// Extras activated by a later path to a package must be available when
/// selecting source variants from that package.
#[test]
fn requirements_txt_requeues_growing_activation_context() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    let package_a = context.temp_dir.child("pkg-a");
    ...
    let package_b = context.temp_dir.child("pkg-b");
    ...
    uv_snapshot!(context.filters(), context
        .export()
        .arg("--no-emit-workspace")
        .arg("--no-hashes"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --no-emit-workspace --no-hashes
...
/// extras before selecting sources during export.
#[test]
fn requirements_txt_group_project_dependency_activates_extra() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --group use --no-emit-workspace --no-hashes
    ./ok-1.0.0-py3-none-any.whl
        # via pkg-a
...
/// Pruned dependency-group edges must not activate extras that select sources
/// for retained packages.
#[test]
fn requirements_txt_pruned_group_dependency_does_not_activate_source() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --group use --prune pkg-a --no-emit-workspace --no-hashes
    ok==2.0.0
        # via project
...
/// Pruned transitive dependency-group edges must not activate extras that select
/// sources for retained packages.
#[test]
fn requirements_txt_pruned_transitive_group_dependency_does_not_activate_source() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --group use --prune pkg-b --no-emit-workspace --no-hashes
    ok==2.0.0
        # via project
...
/// exporting a synthesized group fallback.
#[test]
fn requirements_txt_only_group_excludes_production_fallback_edges() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --preview-features package-conflicts --only-group use --no-hashes
    certifi==2024.2.2 ; python_full_version >= '3.12' and sys_platform == 'win32'
        # via requests
    charset-normalizer==3.3.2 ; python_full_version >= '3.12' and sys_platform == 'win32'
        # via requests
    idna==3.6 ; python_full_version >= '3.12' and sys_platform == 'win32'
        # via requests
...
#[test]
fn requirements_txt_only_group_self_activates_production_dependencies() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --preview-features package-conflicts --only-group self --no-hashes
    certifi==2024.2.2
        # via requests
...
#[test]
fn requirements_txt_root_group_activates_dependency_project() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --preview-features package-conflicts --only-group install --no-hashes
    -e ./child
    iniconfig==2.0.0
        # via child
...
/// Conditional workspace projects selected by a root dependency group must
/// retain their activation markers when their dependency paths converge.
#[test]
fn requirements_txt_root_group_preserves_conditional_project_activation() -> Result<()> {
    ...
    context.temp_dir.child("pyproject.toml").write_str(
        ...
        [dependency-groups]
        install = [
            "member-a ; sys_platform == 'linux'",
            "member-b ; sys_platform != 'linux'",
        ]
    ...
    context
        ...
        version = "0.1.0"
        requires-python = ">=3.12"
        dependencies = ["jinja2==3.1.4", "markupsafe==2.1.5"]
        "#,
        )?;
    ...
    context
        ...
        version = "0.1.0"
        requires-python = ">=3.12"
        dependencies = ["jinja2==3.1.4", "markupsafe==3.0.2"]
        "#,
        )?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --preview-features package-conflicts --only-group install --no-emit-workspace --no-hashes
    jinja2==3.1.4
        # via
        #   member-a
        #   member-b
    markupsafe==2.1.5 ; sys_platform == 'linux'
        ...
        #   jinja2
        #   member-a
    markupsafe==3.0.2 ; sys_platform != 'linux'
        # via
        #   jinja2
        #   member-b
...
#[test]
fn requirements_txt_root_group_activates_member_group_source() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --group alt --no-hashes
    -e ./pkg-a
...
/// extras required by source-selection markers during export.
#[test]
fn requirements_txt_root_group_recursively_activates_dependency_extra() -> Result<()> {
    let context = uv_test::test_context!("3.12");
