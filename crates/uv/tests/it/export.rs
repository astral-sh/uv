...
fn export_comma_separated_extras() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.export().arg("--extra").arg("dev,test"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --extra dev,test
    iniconfig==2.0.0 \
        --hash=sha256:2d91e135bf72d31a410b17c16da610a82cb55f6b0477d1a902134b24a455b8b3 \
        --hash=sha256:b6a85871a79d2e3b22d2d1b94ac2824226a63c6b741c88f7ae975f18b6778374
        # via project
...
fn export_mixed_extras() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.export().arg("--extra").arg("dev,test").arg("--extra").arg("docs"), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --extra dev,test --extra docs
    anyio==4.3.0 \
        --hash=sha256:048e05d0f6caeed70d731f3db756d35dcc1f35747c8c403364a8332c630441b8 \
        --hash=sha256:f75253795a87df48568485fd18cdd2a3fa5c4f7c5be8e5e36637733fce06fed6
        # via project
...
fn export_invalid_comma_separated_extras() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.export().arg("--extra").arg("dev,nonexistent"), @r"
    success: false
    exit_code: 2
    ----- stdout -----
