...
/// Install a package via `--extra-index-url`.
///
/// With `unsafe-closest-match`, the resolver should prefer the highest compatible version,
...
fn compile_index_url_unsafe_highest() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] --exclude-newer 2024-03-25T00:00:00Z --index-strategy unsafe-closest-match requirements.in --no-deps
    anyio==4.3.0
...
/// Install a package via `--extra-index-url`.
///
/// With `unsafe-closest-match`, the resolver should prefer the lowest compatible version,
/// regardless of which index it comes from.
///
...
fn compile_index_url_unsafe_lowest() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] --exclude-newer 2024-03-25T00:00:00Z --resolution lowest --index-strategy unsafe-closest-match requirements.in --no-deps
    anyio==1.0.0
