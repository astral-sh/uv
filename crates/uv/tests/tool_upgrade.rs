...
fn test_tool_upgrade_name() {
    ...
    ----- stderr -----
    Installing to environment at tools/babel/bin/python3
...
fn test_tool_upgrade_multiple_names() {
    ...
    ----- stderr -----
    Resolved [N] packages in [TIME]
    Installing to environment at tools/python-dotenv/bin/python
    Prepared [N] packages in [TIME]
    Installed [N] packages in [TIME]
    ...
    Updated babel v2.6.0 -> v2.14.0
     ...
     - pytz==2018.5
    Installed 1 executable: pybabel
    Installing to environment at tools/python-dotenv/bin/python3
