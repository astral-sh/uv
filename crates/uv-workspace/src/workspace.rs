...
use uv_cache::Cache;
use uv_configuration::{DependencyGroupsWithDefaults, DependencyModifier};
...
impl Workspace {
    ...
    pub fn overrides(&self) -> Vec<DependencyModifier<uv_pep508::Requirement<VerbatimParsedUrl>>> {
    ...
    pub fn exclude_dependencies(&self) -> Vec<DependencyModifier<PackageName>> {
