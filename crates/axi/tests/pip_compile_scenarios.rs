...
use common::{axi_snapshot, create_bin_with_executables, get_bin, TestContext, INSTA_FILTERS};
...
fn requires_incompatible_python_version_compatible_override() -> Result<()> {
    ...
    let output = axi_snapshot!(filters, command(&context, python_versions)
        ...
        , @r###"
                 ...
                 #    axi pip compile requirements.in --extra-index-url https://test.pypi.org/simple --cache-dir [CACHE_DIR] --python-version=3.11
                 albatross==1.0.0
...
fn requires_python_patch_version_override_patch_compatible() -> Result<()> {
    ...
    let output = axi_snapshot!(filters, command(&context, python_versions)
        ...
        , @r###"
                 ...
                 ----- stdout -----
                 # This file was autogenerated by Axi v[VERSION] via the following command:
                 #    axi pip compile requirements.in --extra-index-url https://test.pypi.org/simple --cache-dir [CACHE_DIR] --python-version=3.8.0
                 albatross==1.0.0
