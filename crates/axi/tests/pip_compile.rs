...
use common::{axi_snapshot, TestContext, INSTA_FILTERS};
...
fn compile_requirements_in() -> Result<()> {
    ...
    axi_snapshot!(context
        .compile()
        .arg("requirements.in"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in
    asgiref==3.7.2
        # via django
    django==5.0b1
    sqlparse==0.4.4
...
"#,
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z pyproject.toml
    asgiref==3.7.2
        # via django
    django==5.0b1
    sqlparse==0.4.4
...
fn compile_constraints_txt() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --constraint constraints.txt
    asgiref==3.7.2
        # via django
    django==5.0b1
    sqlparse==0.4.3
...
"#,
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z pyproject.toml --extra foo
    asgiref==3.7.2
        # via django
    django==5.0b1
    sqlparse==0.4.4
...
"#,
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z pyproject.toml --extra FRiENDlY-...-_-BARd
    asgiref==3.7.2
        # via django
    django==5.0b1
    sqlparse==0.4.4
...
fn compile_python_312() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --python-version 3.12
    black==23.10.1
    click==8.1.7
        # via black
...
fn compile_python_37() -> Result<()> {
    ...
    axi_snapshot!(filters, context.compile()
            .arg("requirements.in")
            .arg("--python-version")
            .arg("3.7"), @r###"
    success: false
...
fn compile_numpy_py38() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --no-build
    numpy==1.24.4
...
"#,
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z pyproject.toml --all-extras
    anyio==4.0.0
        # via httpcore
    asgiref==3.7.2
        # via django
...
"#,
    ...
    Usage: axi pip compile --cache-dir [CACHE_DIR] --all-extras <SRC_FILE>...
...
fn compile_exclude_newer() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile requirements.in --exclude-newer 2022-04-04T12:00:00Z --cache-dir [CACHE_DIR]
    tqdm==4.64.0
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile requirements.in --exclude-newer 2022-04-04 --cache-dir [CACHE_DIR]
    tqdm==4.64.0
...
fn override_dependency() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --override overrides.txt
    blinker==1.7.0
        # via flask
    click==8.1.7
        # via flask
...
fn compile_editable() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile requirements.in --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z
    -e ${PROJECT_ROOT}/../../scripts/editable-installs/maturin_editable
    -e ../../scripts/editable-installs/poetry_editable
...
fn compile_html() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile requirements.in --cache-dir [CACHE_DIR] --index-url https://download.pytorch.org/whl
    jinja2==3.1.2
    markupsafe==2.1.3
        # via jinja2
...
fn trailing_slash() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --index-url https://test.pypi.org/simple
    jinja2==3.1.2
    markupsafe==2.1.3
        # via jinja2
...
fn compile_legacy_sdist_setuptools() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --legacy-setup-py
    flake8 @ https://files.pythonhosted.org/packages/66/53/3ad4a3b74d609b3b9008a10075c40e7c8909eae60af53623c3888f7a529a/flake8-6.0.0.tar.gz
    mccabe==0.7.0
        # via flake8
    pycodestyle==2.10.0
...
fn generate_hashes() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --generate-hashes
    blinker==1.7.0 \
...
fn find_links_directory() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --find-links [PROJECT_ROOT]/scripts/wheels
    markupsafe==2.1.3
        # via werkzeug
    numpy==1.26.2
    tqdm==1000.0.0
...
fn find_links_url() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --no-index --find-links https://download.pytorch.org/whl/torch_stable.html
    tqdm==4.64.1
...
fn find_links_requirements_txt() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --no-index --emit-find-links
...
fn upgrade_all() -> Result<()> {
    ...
    requirements_txt.write_str(indoc! {r"
        ...
        #    axi pip compile requirements.in --python-version 3.12 --cache-dir [CACHE_DIR]
        black==23.10.1
        click==8.1.2
            # via black
        mypy-extensions==1.0.0
...
fn no_annotate() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --no-annotate
    black==23.10.1
    click==8.1.7
    mypy-extensions==1.0.0
    packaging==23.2
...
fn allow_unsafe() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --allow-unsafe
    markupsafe==2.1.3
        # via werkzeug
    werkzeug==3.0.1

    ----- stderr -----
    warning: pip-compile's `--allow-unsafe` has no effect (Axi can safely pin `pip` and other packages).
    Resolved 2 packages in [TIME]
    "###
    );
...
fn resolver_legacy() -> Result<()> {
    ...
    ----- stderr -----
    error: pip-compile's `--resolver=legacy` is unsupported (Axi always backtracks).
    "###
    );
...
fn emit_index_urls() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --emit-index-url --extra-index-url https://test.pypi.org/simple/
...
fn emit_find_links() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --emit-find-links --find-links ./
    --find-links ./
...
fn index_url_requirements_txt() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --index-url https://pypi.org/simple
    tqdm==4.66.1
...
fn offline() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by Axi v[VERSION] via the following command:
    #    axi pip compile --cache-dir [CACHE_DIR] --exclude-newer 2023-11-18T12:00:00Z requirements.in --offline
    black==23.10.1
    click==8.1.7
        # via black
    mypy-extensions==1.0.0
