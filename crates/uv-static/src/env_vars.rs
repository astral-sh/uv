...
impl EnvVars {
    ...
    /// Equivalent to `--reuse-build-environment-package`.
    ///
    /// Accepts a space-delimited list of packages.
    #[attr_added_in("next release")]
    pub const UV_REUSE_BUILD_ENVIRONMENT_PACKAGE: &'static str =
        "UV_REUSE_BUILD_ENVIRONMENT_PACKAGE";
