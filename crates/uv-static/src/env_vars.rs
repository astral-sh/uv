...
impl EnvVars {
    ...
    /// Overrides libc selection on linux systems when determining the current platform for
    /// managed python downloads. Options are: gnu, gnueabi, gnueabihf, musl, and none.
