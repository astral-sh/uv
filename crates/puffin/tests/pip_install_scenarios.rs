...
fn requires_python_version_less_than_current() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because the current Python version (3.9.17) does not satisfy Python<=3.8 and albatross==1.0.0 depends on Python<=3.8, we can conclude that albatross==1.0.0 cannot be used.
              And because root depends on albatross==1.0.0 we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn requires_python_version_greater_than_current() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because the current Python version (3.9.17) does not satisfy Python>=3.10 and albatross==1.0.0 depends on Python>=3.10, we can conclude that albatross==1.0.0 cannot be used.
              And because root depends on albatross==1.0.0 we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn requires_python_version_greater_than_current_excluded() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because the current Python version (3.9.17) does not satisfy Python>=3.10,<3.11 and the current Python version (3.9.17) does not satisfy Python>=3.12, we can conclude that any of:
                  Python>=3.10,<3.11
                  Python>=3.12
               are incompatible.
              And because the current Python version (3.9.17) does not satisfy Python>=3.11,<3.12 we can conclude that Python>=3.10 are incompatible.
              ...
              Because the current Python version (3.9.17) does not satisfy Python>=3.11,<3.12 and the current Python version (3.9.17) does not satisfy Python>=3.12, we can conclude that Python>=3.11 are incompatible.
              ...
              Because the current Python version (3.9.17) does not satisfy Python>=3.12 and albatross==4.0.0 depends on Python>=3.12, we can conclude that albatross==4.0.0 cannot be used.
