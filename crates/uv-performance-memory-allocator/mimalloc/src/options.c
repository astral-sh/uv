...
#define MI_DEFAULT_PURGE_DELAY 1000
#endif

#ifndef MI_DEFAULT_ARENA_PURGE_MULT
#define MI_DEFAULT_ARENA_PURGE_MULT 1
#endif
...
static mi_option_desc_t mi_options[_mi_option_last] =
{
  ...
  { MI_DEFAULT_PURGE_DELAY, MI_OPTION_UNINIT, MI_OPTION_LEGACY(purge_delay,reset_delay) },  // purge delay in milli-seconds
  ...
  { MI_DEFAULT_ARENA_PURGE_MULT, MI_OPTION_UNINIT, MI_OPTION(arena_purge_mult) },         // purge delay multiplier for arena's
