...
fn benchmark_configuration() -> Criterion<WallTime> {
    uv_preview::set(Preview::default()).expect("preview state should be uninitialized");
    uv_preview::finalize().expect("preview state should not be finalized");
    Criterion::default()
}
