...
impl Manifest {
    ...
    /// Return lookahead requirements that may apply for some subset of the requested extras.
    ///
    ...
    pub(crate) fn potential_url_requirements_no_overrides(
        &self,
        mode: DependencyMode,
    ) -> impl Iterator<Item = Cow<'_, Requirement>> + '_ {
        match mode {
