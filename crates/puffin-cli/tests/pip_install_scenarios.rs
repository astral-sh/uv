...
fn excluded_only_compatible_version() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because a<2.0.0 depends on b==1.0.0 and a==3.0.0 depends on b==3.0.0, we can conclude that any of:
                  a<2.0.0
                  a>2.0.0
              depends on one of:
                  b<=1.0.0
...
fn dependency_excludes_range_of_compatible_versions() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because c==2.0.0 depends on a>=3.0.0 and c<2.0.0 depends on a<2.0.0, we can conclude that all versions of c depends on one of:
                  a<2.0.0
                  a>=3.0.0

              And because a<2.0.0 depends on b==1.0.0 and a==3.0.0 depends on b==3.0.0, we can conclude that all versions of c depends on one of:
                  b<=1.0.0
                  b>=3.0.0
...
fn dependency_excludes_non_contiguous_range_of_compatible_versions() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because c<2.0.0 depends on a<2.0.0 and a<2.0.0 depends on b==1.0.0, we can conclude that c<2.0.0 depends on b==1.0.0.
              And because c==2.0.0 depends on a>=3.0.0 and a>=3.0.0 depends on b==3.0.0, we can conclude that all versions of c depends on one of:
                  b<=1.0.0
                  b>=3.0.0
...
fn extra_incompatible_with_extra() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of a[extra-c] depends on b==2.0.0 and a[extra-b]==1.0.0 depends on b==1.0.0, we can conclude that a[extra-b]==1.0.0 and all versions of a[extra-c] are incompatible.
...
fn extra_incompatible_with_root() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of a[extra] depends on b==1.0.0 and root depends on a[extra], we can conclude that root depends on b==1.0.0.
              And because root depends on b==2.0.0 we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn transitive_incompatible_with_root_version() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of a depends on b==2.0.0 and root depends on b==1.0.0, we can conclude that root==0a0.dev0 and all versions of a are incompatible.
              And because root depends on a we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn transitive_incompatible_with_transitive() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of b depends on c==2.0.0 and a==1.0.0 depends on c==1.0.0, we can conclude that all versions of b and a==1.0.0 are incompatible.
...
fn transitive_package_only_prereleases_in_range() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of a depends on b>0.1 and root depends on a, we can conclude that the requirements are unsatisfiable.
...
fn transitive_prerelease_and_stable_dependency() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of a depends on c==2.0.0b1 and root depends on a, we can conclude that the requirements are unsatisfiable.
...
fn transitive_prerelease_and_stable_dependency_many_versions() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of b depends on c and a==1.0.0 depends on c>=2.0.0b1, we can conclude that all versions of b and a==1.0.0 are incompatible.
              And because root depends on b and root depends on a, we can conclude that the requirements are unsatisfiable.
...
fn transitive_prerelease_and_stable_dependency_many_versions_holes() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because all versions of a depends on one of:
                  c>1.0.0,<2.0.0a5
                  c>2.0.0a7,<2.0.0b1
                  c>2.0.0b1,<2.0.0b5
...
fn requires_python_version_does_not_exist() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because a==1.0.0 depends on Python>=4.0 and root depends on a==1.0.0, we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn requires_python_version_less_than_current() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because a==1.0.0 depends on Python<=3.8 and root depends on a==1.0.0, we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn requires_python_version_greater_than_current() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because a==1.0.0 depends on Python>=3.10 and root depends on a==1.0.0, we can conclude that the requirements are unsatisfiable.
        "###);
    });
...
fn requires_python_version_greater_than_current_excluded() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because there are no versions of Python that satisfy Python>=3.10 and a==2.0.0 depends on Python>=3.10, we can conclude that a==2.0.0 cannot be used. (1)

              Because there are no versions of Python that satisfy Python>=3.11 and a==3.0.0 depends on Python>=3.11, we can conclude that a==3.0.0 cannot be used.
              And because we know from (1) that a==2.0.0 cannot be used, we can conclude that a>=2.0.0,<4.0.0 cannot be used.
              And because a==4.0.0 depends on Python>=3.12 and root depends on a>=2.0.0, we can conclude that the requirements are unsatisfiable.
        "###);
    });
