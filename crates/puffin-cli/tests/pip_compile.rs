...
fn compile_python_37() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          ...
          ╰─▶ Because black==23.10.1 depends on Python>=3.8 and root depends on
...
fn conflicting_transitive_url_dependency() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ Because flask==3.0.0 depends on werkzeug>=3.0.0 and root depends on
...
"#,
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ my-project depends on django==300.1.4
        "###);
    });
...
fn compile_yanked_version_indirect() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        ----- stderr -----
          × No solution found when resolving dependencies:
          ╰─▶ root depends on attrs>20.3.0,<21.2.0
        "###);
    });
