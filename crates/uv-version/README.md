...
This version (0.10.9) is a component of [uv 0.10.9](https://crates.io/crates/uv/0.10.9). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.10.9/crates/uv-version).
