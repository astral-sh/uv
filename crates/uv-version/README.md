...
This version (0.11.9) is a component of [uv 0.11.9](https://crates.io/crates/uv/0.11.9). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.11.9/crates/uv-version).
