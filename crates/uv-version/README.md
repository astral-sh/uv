...
This version (0.9.26) is a component of [uv 0.9.26](https://crates.io/crates/uv/0.9.26). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.26/crates/uv-version).
