...
This version (0.11.25) is a component of [uv 0.11.25](https://crates.io/crates/uv/0.11.25). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.25/crates/uv-version).
