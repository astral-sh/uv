...
This version (0.11.17) is a component of [uv 0.11.17](https://crates.io/crates/uv/0.11.17). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.17/crates/uv-version).
