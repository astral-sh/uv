...
This version (0.11.11) is a component of [uv 0.11.11](https://crates.io/crates/uv/0.11.11). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.11/crates/uv-version).
