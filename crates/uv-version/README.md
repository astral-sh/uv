...
This version (0.11.8) is a component of [uv 0.11.8](https://crates.io/crates/uv/0.11.8). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.11.8/crates/uv-version).
