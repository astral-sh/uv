...
This version (0.11.0) is a component of [uv 0.11.0](https://crates.io/crates/uv/0.11.0). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.11.0/crates/uv-version).
