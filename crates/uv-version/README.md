...
This version (0.9.27) is a component of [uv 0.9.27](https://crates.io/crates/uv/0.9.27). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.27/crates/uv-version).
