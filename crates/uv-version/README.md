...
This version (0.12.6) is a component of [uv 0.12.6](https://crates.io/crates/uv/0.12.6). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.6/crates/uv-version).
