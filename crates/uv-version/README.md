...
This version (0.9.25) is a component of [uv 0.9.25](https://crates.io/crates/uv/0.9.25). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.25/crates/uv-version).
