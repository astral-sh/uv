...
This version (0.10.0) is a component of [uv 0.10.0](https://crates.io/crates/uv/0.10.0). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.10.0/crates/uv-version).
