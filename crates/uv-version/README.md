...
This version (0.12.0) is a component of [uv 0.12.0](https://crates.io/crates/uv/0.12.0). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.0/crates/uv-version).
