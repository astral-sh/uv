...
This version (0.11.29) is a component of [uv 0.11.29](https://crates.io/crates/uv/0.11.29). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.29/crates/uv-version).
