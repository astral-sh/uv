...
This version (0.10.7) is a component of [uv 0.10.7](https://crates.io/crates/uv/0.10.7). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.10.7/crates/uv-version).
