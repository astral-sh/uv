...
This version (0.11.21) is a component of [uv 0.11.21](https://crates.io/crates/uv/0.11.21). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.21/crates/uv-version).
