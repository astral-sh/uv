...
This version (0.11.2) is a component of [uv 0.11.2](https://crates.io/crates/uv/0.11.2). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.11.2/crates/uv-version).
