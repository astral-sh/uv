...
This version (0.12.2) is a component of [uv 0.12.2](https://crates.io/crates/uv/0.12.2). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.2/crates/uv-version).
