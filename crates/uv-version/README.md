...
This version (0.11.24) is a component of [uv 0.11.24](https://crates.io/crates/uv/0.11.24). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.24/crates/uv-version).
