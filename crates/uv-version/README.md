...
This version (0.11.31) is a component of [uv 0.11.31](https://crates.io/crates/uv/0.11.31). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.31/crates/uv-version).
