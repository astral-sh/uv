...
This version (0.9.28) is a component of [uv 0.9.28](https://crates.io/crates/uv/0.9.28). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.28/crates/uv-version).
