...
This version (0.12.10) is a component of [uv 0.12.10](https://crates.io/crates/uv/0.12.10). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.12.10/crates/uv-version).
