...
This version (0.9.30) is a component of [uv 0.9.30](https://crates.io/crates/uv/0.9.30). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.30/crates/uv-version).
