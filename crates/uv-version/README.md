...
This version (0.10.10) is a component of [uv 0.10.10](https://crates.io/crates/uv/0.10.10). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.10.10/crates/uv-version).
