...
This version (0.11.23) is a component of [uv 0.11.23](https://crates.io/crates/uv/0.11.23). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.23/crates/uv-version).
