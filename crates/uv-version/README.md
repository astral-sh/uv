...
This version (0.10.4) is a component of [uv 0.10.4](https://crates.io/crates/uv/0.10.4). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.10.4/crates/uv-version).
