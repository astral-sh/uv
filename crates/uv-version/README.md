...
This version (0.11.26) is a component of [uv 0.11.26](https://crates.io/crates/uv/0.11.26). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.26/crates/uv-version).
