...
This version (0.11.22) is a component of [uv 0.11.22](https://crates.io/crates/uv/0.11.22). The
source can be found [here](https://github.com/astral-sh/uv/blob/0.11.22/crates/uv-version).
