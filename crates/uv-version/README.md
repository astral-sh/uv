...
This version (0.12.5) is a component of [uv 0.12.5](https://crates.io/crates/uv/0.12.5). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.5/crates/uv-version).
