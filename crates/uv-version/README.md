...
This version (0.10.3) is a component of [uv 0.10.3](https://crates.io/crates/uv/0.10.3). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.10.3/crates/uv-version).
