...
This version (0.9.16) is a component of [uv 0.9.16](https://crates.io/crates/uv/0.9.16). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.16/crates/uv-version).
