...
use uv_distribution_types::{
    ...
    InstalledDirectUrlDist, InstalledDist, InstalledDistKind, InstalledEggInfoDirectory, Name,
...
impl InstalledPackages {
    ...
    fn is_duplicate_distribution(
        ...
        for existing_id in existing_ids {
            ...
            if let InstalledDistKind::EggInfoDirectory(InstalledEggInfoDirectory {
                base_path: Some(base_path),
                ..
            }) = &dist_info.kind
            {
                if let InstalledDistKind::Url(InstalledDirectUrlDist { url, .. }) = &existing.kind {
