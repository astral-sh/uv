...
pub struct CheckArgs {
    ...
    ///
    /// By default, the exact version resolved in `uv.lock` will be used when `ty` is an applicable
    /// project dependency or a dependency in the project's `dev` group. Otherwise, a constrained
    /// version range of ty will be used (e.g., `>=0.0,<0.1`).
    #[arg(long, value_hint = ValueHint::Other)]
