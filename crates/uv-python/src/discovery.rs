...
fn python_executables<'a>(
    ...
    let from_installed =
        python_executables_from_installed(version, implementation, preference, preview);
...
fn python_interpreters<'a>(
    ...
    python_interpreters_from_executables(
        ...
        python_executables(version, implementation, environments, preference, preview).filter_ok(
            move |(source, path)| {
    ...
    match request {
        ...
        PythonRequest::Version(version) => {
            ...
            Box::new({
                ...
                python_interpreters(version, None, environments, preference, cache, preview)
                    .map_ok(|tuple| Ok(PythonInstallation::from_tuple(tuple)))
            })
        }
