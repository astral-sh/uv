...
This version (0.0.70) is a component of [uv 0.12.3](https://crates.io/crates/uv/0.12.3). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.3/crates/uv-distribution-filename).
