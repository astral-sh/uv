...
This version (0.0.38) is a component of [uv 0.11.5](https://crates.io/crates/uv/0.11.5). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.11.5/crates/uv-distribution-filename).
