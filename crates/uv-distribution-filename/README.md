...
This version (0.0.18) is a component of [uv 0.9.29](https://crates.io/crates/uv/0.9.29). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.9.29/crates/uv-distribution-filename).
