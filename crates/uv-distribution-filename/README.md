...
This version (0.0.75) is a component of [uv 0.12.8](https://crates.io/crates/uv/0.12.8). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.8/crates/uv-distribution-filename).
