...
This version (0.0.74) is a component of [uv 0.12.7](https://crates.io/crates/uv/0.12.7). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.12.7/crates/uv-distribution-filename).
