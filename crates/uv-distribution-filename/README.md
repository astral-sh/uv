...
This version (0.0.37) is a component of [uv 0.11.4](https://crates.io/crates/uv/0.11.4). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.11.4/crates/uv-distribution-filename).
