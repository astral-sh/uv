...
This version (0.0.22) is a component of [uv 0.10.2](https://crates.io/crates/uv/0.10.2). The source
can be found [here](https://github.com/astral-sh/uv/blob/0.10.2/crates/uv-distribution-filename).
