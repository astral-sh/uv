...
impl RequirementsSpecification {
    ...
    pub async fn from_source(
        ...
        Ok(match source {
            ...
            RequirementsSource::PyprojectToml(path) => {
                ...
                Self::parse_direct_pyproject_toml(&contents, extras, path)?
            }
    ...
    /// PEP 621.
    fn parse_direct_pyproject_toml(
        contents: &str,
        extras: &ExtrasSpecification,
        path: &PathBuf,
    ) -> Result<Self> {
        ...
        match UvMetadata::try_from(pyproject, extras, &workspace_sources, &workspace_packages) {
